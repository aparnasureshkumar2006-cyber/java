...
public class GoldScreen {
    ...
    public GoldScreen(String bookingId,int ticketPrice,int snackPrice,int totalBill,Viewer viewer){
    ...
    public void calculateTicketPrice(){
        this.setTicketPrice(this.viewer.getNumberOfSeats()*500);
    ...
    public void calculateSnackPrice(){
        if(this.viewer.getWantsSnacks().equals("YES")){
            this.setSnackPrice(this.viewer.getSnackQuantity()*150);
    ...
    public void generateBill(){
        this.setTotalBill(this.ticketPrice+this.snackPrice+100);
